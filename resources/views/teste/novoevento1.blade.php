...
<div class="modal fade" id="eventopago" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                     ...
                     <label for="local">Nome do ingresso?</label>
                      <input type="text" class="form-control" name="nomeingresso" value="{{old('nomeingresso')}}" id="nomeingresso"
                        ...
                        <div class="col-12 col-md-6 form-group">
                     <label for="local"> Quantidade de ingressos para a venda?</label>
                      <input type="text" class="form-control" name="quantidade" value="{{old('quantidade')}}" id="quantidade"
                        placeholder="Número de ingressos">
                      </div>

                      <div class="col-12 col-md-6 form-group">
                     <label for="local"> Qual o valor do ingresso ?</label>
                      <input type="text" class="form-control" name="valor" value="{{old('valor')}}" id="valor"
                        placeholder="R$">
                      </div>
                    ...
                    <input type="text" aria-label="First name" class="form-control" placeholder="Mínimo"><br>
                    <input type="text" aria-label="Last name" class="form-control" placeholder="Máximo">
                      </div>                      
                                ...
                                <div class="row" >
                                        <div class="col-12 col-md-6">
                                             ...
                                             <label for="mesadoevento"> O evento possui mesa?</label>
                                              ...
                                              <div class="form-check form-check-inline">
                                            <input class="form-check-input simmesa" type="radio" name="mesadoevento" id="mesadoevento" value="simmesa" >
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input naomesa" type="radio" name="mesadoevento" id="mesadoevento" value="naomesa">
                                                <label class="form-check-label" for="mesadoevento">
                                                    Não
                                                </label>
                                            </div> 
                                        ...
                                        <div class="col-12  quantidademesas" style="display: none">
                                            <div class="form-check form-check-inline">
                                            <label>Quantidade de mesas:</label>
                                            <input type="text" class=" col-8 form-control" name="quantidademesas" value="" id="quantidademesas"
                                                placeholder="Numero de mesas">
                                            </div>

                                            <div class="form-check form-check-inline">
                                            <label>Quantidade de assentos:</label>
                                            <input type="text" class=" col-8 form-control" name="quantidadeassentos" value="" id="quantidadeassentos"
                                                placeholder="Numero de assentos na mesa">
                                            </div>
                                 ...
                                 <div class="row" >
                                        <div class="col-12 col-md-6">
                                             ...
                                             <label for="periodo"> Período de vendas:</label>
                                            </div>
                                              <div class="form-check form-check-inline">
                                            <input class="form-check-input pdata" type="checkbox" name="periodo" id="periodo" value="pdata" >
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input plote" type="checkbox" name="periodo" id="periodo" value="plote">
                                                <label class="form-check-label" for="periodo">
                                                    Por lote
                                                </label>
                                            </div> 
                                        ...
                                        <div class="col-12  datavendas" style="display: none">
                                        <div class="row">
                                            <div class="col-12 col-md-6 form-group">
                                        ...
                                        <div class="col-12  datalote" style="display: none">
                                        <div class="row">
                                            <div class="col-12 col-md-6 form-group">
                                            <label for="data_ini">Data de Início do lote</label>
                                            <input type="date" class="form-control {{$errors->has('data_inicio') ? 'is-invalid' : ''}}"
                                                name="data_iniciovenda" value="{{old('data_iniciovenda')}}" id="data_iniv" placeholder="__/__/____">
                                            @if($errors->has('data_iniciovenda')) <div class="invalid-feedback">{{$errors->first('data_inicio')}}
                                            </div>@endif
                                        ...
                                        <div class="col-12 col-md-6 form-group">
                                            <label for="data_fim">Data de Encerramento do lote </label>
                                            <input type="date" class="form-control {{$errors->has('data_fim') ? 'is-invalid' : ''}}"
                                                name="data_fimvenda" value="{{old('data_fimvenda')}}" id="data_fimv" placeholder="__/__/____">
                                            @if($errors->has('data_fim')) <div class="invalid-feedback">{{$errors->first('data_fim')}}</div>
                                            @endif
                                        ...
                                        <div class="col-12 col-md-6 form-group">
                                        <label for="local"> Número de lotes ?</label>
                                        <input type="text" class="form-control" name="valor" value="{{old('valor')}}" id="valor"
                                            placeholder="">
                                        </div>
            ...
            <div class="row">
                <div class="col-12 ">
                    <label for="descricaoingresso">Descrição do ingresso</label><br>
                    <textarea class="col-12 " name="descricaoingresso" id="summernote">{{ old('descricaoingresso') }}</textarea>
                </div>
            </div>
                              </div>
...
<script type="text/javaScript">
    ...
    $("input").change(function() {
        ...
        if ($('.simmesa').prop("checked") == true) {
            ...
            for(var o=0;o<ele1.length;o++)
            ele1[o].checked = false;        
            $('.quantidademesas').hide();   
        }

        if ($('.pdata').prop("checked") == true) {
            $('.datavendas').fadeIn("show");
        } else {
            var ele1 = document.getElementsByName("datavendas");
            for(var o=0;o<ele1.length;o++)
            ele1[o].checked = false;        
            $('.datavendas').hide();   
        }

        if ($('.plote').prop("checked") == true) {
            $('.datalote').fadeIn("show");
        } else {
            var ele1 = document.getElementsByName("datalote");
            for(var o=0;o<ele1.length;o++)
            ele1[o].checked = false;        
            $('.datalote').hide();   
        }
