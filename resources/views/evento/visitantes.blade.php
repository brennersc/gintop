                ...
                <div class="row">
                        ...
                        <div class="col-md-3 col-sm-9">
                                <a href="#" class="btn btn-md btn-outline-primary ml-1 float-right" data-toggle="modal"
                                        ...
                                        Importar</a>
                                <a href="{{route('excelcred', ['exibir' => $exibir->id])}}"
                                        ...
                                        <tr>
                                                ...
                                                <td style="text-align:center;">
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                <a href="{{route('imprimir', ['cpf' => $tabela->cpf, 'id' => $exibir->id])}}"
                                                                        target="_blank"
                ...
                <div class="modal-content">
                        ...
                        <div class="modal-body">
                                <form class="form" id="formImport"
                                        action="{{route('importcred', ['id' => $exibir->id])}}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
...
<div class="modal fade bd-example-modal-xl" id="modalvisitantes" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                        ...
                        <div class="modal-body">
                                <form class="form" id="formCredencianto" action="/cadastrarcred/{{$exibir->id}}"
                                        method="POST">
                                        @csrf
                                        {{-- <div class="row">
                                ...
                                <div class="row" id="linha">
                                        ...
                                        <div class="col-3">
                                                <a id="apagar" class="btn btn-md btn-danger"
                                                        href="/apagarvisitante/{{ base64_encode($tabela->cpf) }}"> <i
