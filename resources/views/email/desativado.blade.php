    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-radius: 10px;">
        <tr>
            <td align="center" bgcolor="" style="padding: 30px">
                <img src="https://gintop.com.br/storage/imagens/logo-toptecnologia.png" alt="{{$usuario->empresa}}"
                    ...
                    <tr>
                        <td width="260" valign="top">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                @if($status == 0)
                                    <h4>Sistema Gin Top informa que seu login foi desativado!</h4>                                
                                    
                                    <br>
                                
                                    Caso haja alguma duvida entrem em contato com a administração do sistema.
                                @else 

                                    <h4>Sistema Gin Top informa que seu login foi ATIVADO!</h4>                                
                                    
                                    <h4>Seu Login é: {{$usuario->email}}</h4>
                                    <h4>Sua Senha é: {{$senha}}</h4>
