    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-radius: 10px;">
        <tr>
            <td align="center" bgcolor="" style="padding: 30px">
                <img src="https://gintop.com.br/storage/imagens/logo-toptecnologia.png" alt="GinTop"
                    ...
                    <tr>
                        <td width="260" valign="top">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <h3>Olá {{$verifica_cpf->name}},</h3>                                

                                    <h4>Foi solicitado a alteração de senha ao Gin Top no dia {{ date("d/m/Y - H:i", strtotime(now())) }}</h4>                                
                                    
                                    <h4>Seu Login é: {{$verifica_cpf->cpf}}</h4>
